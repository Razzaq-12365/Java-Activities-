package bookproject.Book.daoimplementation;
...
import bookproject.Book.dao.DAO;
import bookproject.Book.dbconfig.DbConfig;

public class BookImplementation implements DAO  {
	...
	public void insertRecord(int bookId, String bookName, String author, String description, String bookUrl,
			double price) {
...
//		String query = "insert into book values(?,?,?,?,?,?)";
	...
	@Override
	public void updateRecord(int bookId, String bookName, String author, String description, String bookUrl,
			double price) {
		try {
